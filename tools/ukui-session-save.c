...
#define GSM_SERVICE_DBUS_OLD "org.ukui.SessionManager"
#define GSM_PATH_DBUS_OLD "/org/ukui/SessionManager"
#define GSM_INTERFACE_DBUS_OLD "org.ukui.SessionManager"
